<template>
  <div class="projet-card">
    ...
    <div class="projet-content">
      ...
      <div class="centered" v-if="projet.lien && projet.url">
        <a :href="projet.url" target="_blank" rel="noopener noreferrer" class="github-link">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" v-if="projet.lien === 'GitHub'">
            <path
